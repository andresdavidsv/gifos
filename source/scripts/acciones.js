...
let url_tags = "https://api.giphy.com/v1/trending/searches?" + APIKEY;
...
//CREAR GIFOS
let url_upload_gifo = "https://upload.giphy.com/v1/gifs?" + APIKEY;
...
// CAROUSEL
let url_trending = "https://api.giphy.com/v1/gifs/trending?" + APIKEY;
...
let downGifo_id = (gif_title, gif_id) => {
  ...
  let url_downGifo = "https://media2.giphy.com/media/" + gif_id + "/giphy.gif?&" + APIKEY + "&rid=giphy.gif";
  fetch(url_downGifo)
